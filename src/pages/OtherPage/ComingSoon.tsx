          ...
          <div className="mx-auto w-full max-w-[460px] text-center">
            ...
            <form>
              <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium text-gray-900 bg-gray-800 rounded-lg hover:bg-brand-600 dark:bg-brand-500 dark:hover:bg-brand-600 sm:w-auto"
                >
                  <svg
