...
export default function EmailLogsTable() {
  ...
  const fetchLogs = useCallback(
    async (page: number) => {
      ...
      try {
        const params: EmailLogsParams = {
          page,
          limit,
          ...(appliedFilters.customerEmail && {
            customer_email: appliedFilters.customerEmail,
          }),
          ...(appliedFilters.customerName && {
            customer_name: appliedFilters.customerName,
          }),
          ...(appliedFilters.orderNumber && {
            order_number: appliedFilters.orderNumber,
          }),
          ...(appliedFilters.orderStatus && {
            order_status: appliedFilters.orderStatus,
          }),
        };

        const response = await emailLogsService.getPaginated(params);
          ...
          <div className="flex items-center gap-2 sm:justify-end">
            ...
            <div className="relative">
              <select
                ...
                className="h-10 appearance-none rounded-lg border border-gray-300 bg-transparent py-1 pl-3 pr-8 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
              >
              ...
              <span className="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-gray-500">
                <svg width="12" height="8" viewBox="0 0 16 16" fill="none">
                  <path
            ...
            <Table className="w-full table-fixed">
              <TableHeader className="border-t border-gray-100 dark:border-white/[0.05]">
                <TableRow>
                  <TableCell
                    isHeader
                    className="w-[13%] border border-gray-100 px-2 py-2.5 dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Sent At
                    </p>
                  </TableCell>
                  ...
                  <TableCell
                    isHeader
                    className="w-[10%] border border-gray-100 px-2 py-2.5 dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Order #
                    </p>
                  ...
                  <TableCell
                    isHeader
                    className="w-[20%] border border-gray-100 px-2 py-2.5 dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Customer
                    </p>
                  ...
                  <TableCell
                    isHeader
                    className="w-[27%] border border-gray-100 px-2 py-2.5 dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Subject
                    </p>
                  ...
                  <TableCell
                    isHeader
                    className="w-[16%] border border-gray-100 px-2 py-2.5 dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Order Status
                    </p>
                  ...
                  <TableCell
                    isHeader
                    className="w-[8%] border border-gray-100 px-2 py-2.5 text-center dark:border-white/[0.05]"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Status
                    </p>
                  ...
                  <TableCell
                    isHeader
                    className="sticky right-0 z-20 w-[6%] border border-gray-100 bg-white px-2 py-2.5 text-center dark:border-white/[0.05] dark:bg-gray-900"
                  >
                    <p className="text-[11px] font-medium text-gray-700 dark:text-gray-400">
                      Detail
                    </p>
                  ...
                  items.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell className="border border-gray-100 px-2 py-2.5 align-top text-center dark:border-white/[0.05]">
                        <span
                          className={`inline-flex max-w-full items-center justify-center rounded-full px-2 py-0.5 text-[10px] font-semibold leading-4 ${statusClasses(item.status)}`}
                        >
