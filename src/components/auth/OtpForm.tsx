            ...
            <div className="space-y-5">
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-gray-900 transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600"
                >
                  Verify My Account
                </button>
              </div>
