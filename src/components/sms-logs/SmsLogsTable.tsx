  ...
  const fetchLogs = useCallback(
    async (page: number) => {
      ...
      try {
        ...
        const res = await smsLogsService.getPaginated(params);
        setItems(res.items);
    ...
    [limit, orderNumber, customerEmail, phoneNumber, orderStatus, status]
  );
    ...
    <div className="overflow-hidden bg-white dark:bg-white/[0.03] rounded-xl">
      ...
      >
        <input
          ...
          className="h-9 w-32 rounded-lg border border-gray-300 bg-transparent px-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
        />
        <input
          type="email"
          ...
          className="h-9 w-52 rounded-lg border border-gray-300 bg-transparent px-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
        />
        <input
          type="text"
          placeholder="Phone"
          ...
          className="h-9 w-36 rounded-lg border border-gray-300 bg-transparent px-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
        />
        <input
          type="text"
          ...
          className="h-9 w-40 rounded-lg border border-gray-300 bg-transparent px-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
        />
        ...
        {loading ? (
          ...
          <Table>
            <TableHeader className="border-t border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                {["ID", "Sent at", "Order #", "Customer", "Phone", "Order Status", "Status", ""].map((label) => (
                  <TableCell
                    key={label}
                    isHeader
