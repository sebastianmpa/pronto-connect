...
interface TooltipProps {
  ...
  children: ReactNode;
  variant?: "default" | "dark" | "light" | "dark-plain";
}
...
export default function Tooltip({
  ...
  const showArrow = variant === "default" || variant === "dark";

  const variantClasses = (() => {
    switch (variant) {
      case "dark":
        return "bg-gray-900 text-white border border-gray-800 dark:bg-gray-800 dark:border-gray-700";
      case "light":
        return "bg-white text-gray-700 shadow-lg dark:bg-gray-900 dark:text-white";
      case "dark-plain":
        return "bg-gray-900 text-white shadow-lg dark:bg-gray-800";
      default:
        return "bg-white text-gray-700 border border-gray-200 dark:bg-gray-900 dark:text-white dark:border-gray-700";
    }
  })();
