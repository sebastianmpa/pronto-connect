...
export default function SidebarFour() {
  ...
  return (
    <aside
      className={`sidebar fixed top-16 lg:top-19 xl:top-0 xl:sticky left-0 z-9999 flex h-screen flex-col bg-gray-50 transition-all duration-300 dark:bg-gray-900 ${
        isVisible
        ...
        <nav className="space-y-1">
          {navSections.map((section) => (
            <div key={section.id}>
              ...
              <div
                className={`menu-accordion ${openSection === section.id ? "open" : ""}`}
              >
                <div>
